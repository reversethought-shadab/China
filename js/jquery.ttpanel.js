(function($) {
    jQuery.fn.timerTabPanel = function(opt) {
        ...
        var startTimerTabPanel = function() {
            ...
            $(d.tabPanel).on("mouseover", function() {
                clearInterval(tabTimer);
            });
            $(d.tabPanel).on("mouseleave", function() {
                tabTimer = setInterval(tabChange, d.timeInterval);
            });
            // tab panel click action settings
            $(d.tabPanel).find(d.tabElm).on("click", function() {
                n = $(this).index();
            });
