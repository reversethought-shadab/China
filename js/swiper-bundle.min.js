...
! function(e, t) {
    ...
    var I = {
        ...
        slideToLoop: function(e, t, s, a) {
            ...
            const i = this;
            let r = e;
            return i.params.loop && (i.virtual && i.params.virtual.enabled ? r += i.virtual.slidesBefore : r = b(i.slides.filter((e => 1 * e.getAttribute("data-swiper-slide-index") === r))[0])), i.slideTo(r, t, s, a)
        },
        ...
        slideToClickedSlide: function() {
            ...
            if (t.loop) {
                ...
                i = parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"), 10), t.centeredSlides ? r < e.loopedSlides - a / 2 || r > e.slides.length - e.loopedSlides + a / 2 ? (e.loopFix(), r = b(f(s, `${l}[data-swiper-slide-index="${i}"]`)[0]), n((() => {
                    e.slideTo(r)
    ...
    var O = {
        ...
        loopFix: function(e) {
            ...
            const g = [],
                v = [];
            let w = o.activeIndex;
            void 0 === r ? r = b(o.slides.filter((e => e.classList.contains("swiper-slide-active")))[0]) : w = r;
            const y = "next" === a || !a,
                E = "prev" === a || !a;
            let x = 0,
                S = 0;
            ...
            if (E && g.forEach((e => {
                ...
                if (void 0 === t) {
                    ...
                    l ? o.setTranslate(o.translate - t) : (o.slideTo(w - S, 0, !1, !0), i && (o.touches[o.isHorizontal() ? "startX" : "startY"] += t))
    ...
    function oe(e) {
        ...
        if (t.params.virtualTranslate && 0 !== s) {
            let e, s = !1;
            e = i ? a : a.filter((e => b(e.classList.contains("swiper-slide-transform") ? (e => {
    ...
    const ce = [function(e) {
        ...
        function $() {
            ...
            t.wrapperEl.addEventListener("pointerdown", x, s), t.wrapperEl.addEventListener("pointermove", S, a), ["pointerup", "pointercancel"].forEach((e => {
        ...
        function k() {
            ...
            t.wrapperEl.removeEventListener("pointerdown", x, s), t.wrapperEl.removeEventListener("pointermove", S, a), ["pointerup", "pointercancel"].forEach((e => {
        ...
        const c = () => {
                ...
                if (e !== t.slides[t.activeIndex].getAttribute("data-hash")) {
                    const s = b(f(t.slidesEl, `.${t.params.slideClass}[data-hash="${e}"], swiper-slide[data-hash="${e}"]`)[0]);
                    if (void 0 === s) return;
                    t.slideTo(s)
                }
            },
